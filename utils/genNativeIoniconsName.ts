...
export const genNativeIoniconsName = (
  baseName: string,
  platformOS: typeof Platform.OS
) => {
  if (["ios", "macos"].includes(platformOS)) {
    return `ios-${baseName}` as IoniconsValidName;
  }
  return `md-${baseName}` as IoniconsValidName;
};

type IoniconsValidName =
  | "link"
  | "search"
  | "image"
  | "text"
